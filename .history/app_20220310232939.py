...
def edit_profile(username, userid):
    ...
    pfp_url = cursor.fetchone()[0]
    return render_template('profileedit.html', username=session['username'], uid=session['uid'], profile_username=username, profile_userid=userid, description=description)
