...
@app.route('/users/<string:username>.<int:userid>/edit')
def edit_profile(username, userid):
    ...
    return render_template('profileedit.html', username=session['username'], uid=session['uid'], profile_username=username, profile_userid=userid, description=description, profile_picture_url=profile_picture_url)
