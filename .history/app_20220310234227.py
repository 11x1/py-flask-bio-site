...
def profile(username, userid):
    ...
    is_owner = None
    if session['username'] == username: is_owner = True
    ...
    return render_template('profile.html', username=session['username'], uid=session['uid'], profile_username=username, profile_userid=userid, profile_description=profile_description, profile_picture_url=profile_picture_url, is_owner=is_owner)
