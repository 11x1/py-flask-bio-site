...
def profile(username, userid):
    ...
    return render_template('profile.html', username=session['username'], uid=session['uid'], profile_username=username, profile_userid=userid, profile_description=profile_description)
